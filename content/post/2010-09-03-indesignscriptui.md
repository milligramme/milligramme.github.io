+++
title = "ScriptUI版セル幅高さ調整スクリプト"
date = "2010-09-03T00:00:00+09:00"
tags = ["indesign", "extendscript", "scriptui"]
+++

前回の [とりあえずから実用へ（InDesignプロンプト版セル幅調整スクリプト）](http://www.milligramme.cc/wp/archives/628) の続き

せっかくなので高さも調整できるようにしてみる。

![/images/2010/09/783-set_size_with_cals.png](/images/2010/09/783-set_size_with_cals.png)
...
2012-06-25: autoGrowを設定した、数値を0以上に変更