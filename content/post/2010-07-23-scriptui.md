+++
title = "コンテンツに応じてのびのびするダイアログ"
date = "2010-07-23T00:00:00+09:00"
tags = ["indesign", "scriptui"]
+++
のびのびと育ってほしいので、ScriptUIのダイアログをのびるようにしてみました。ダイアログに表示する内容に合わせてサイズを可変させます。当然、項目が多すぎるとディスプレイからはみ出します。

![/images/2010/09/775-stretch_dialog_input.png](/images/2010/09/775-stretch_dialog_input.png)

おまけ、正規表現で設定した内容以外は頑として受け付けません。

![/images/2010/09/776-sd_regex_alert.png](/images/2010/09/776-sd_regex_alert.png)
