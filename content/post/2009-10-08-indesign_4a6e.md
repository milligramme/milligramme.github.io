+++
title = "InDesignでぐりぐり旋回"
date = "2009-10-08T00:00:00+09:00"
tags = ["indesign", "extendscript"]
+++
スパイログラフ（ぐりぐり定規でかいたもの）みたいなものをイメージしたのに、違う物ができてしまう。

ほしかったのは [http://www.zariganiworks.co.jp/korejanairobo/](コレジャナイ)

![img](/images/2010/10/gri_gri.png)

ダイアログの設定によって色々変わります。とりあえずオープンパスの塗り無し、線が［黒］で生成されます。

![img](/images/2010/10/gri_dialog.png)
...
spiraObj.move(undefined, [armMax/2+dWidth*Math.random()-armMax/2, armMax/2+dHeight*Math.random()-armMax/2]);
}
//ルーラーを元に戻す
