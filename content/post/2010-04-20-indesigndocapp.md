+++
title = "docまたはappのデフォルトの単位と増減値を設定するスクリプト"
date = "2010-04-20T00:00:00+09:00"
tags = ["indesign"]
+++
- [InDesign_ ドキュメントの単位と増減値をととのえる](/2009/11/08/indesign.html)
- [InDesign_ドキュメントの単位と増減値をととのえる（再](/2009/11/17/indesign.html)
...
### 変更したところ
- ドキュメントをなにも開いていない場合、アプリケーションデフォルトを設定するように変更（不要な時をチェックボックスも表示しないでメッセージもかえた）。
...
![/images/2010/09/755-set_unit_to_appdef.png](/images/2010/09/755-set_unit_to_appdef.png)
...
単位は4種類
座標がmm・組版が級歯、座標も組版もポイント、座標がmm・組版が級歯、座標がパイカ・組版がポイント。
